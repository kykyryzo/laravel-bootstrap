...
namespace {
    ...
    class BugeException extends \Dinesh\Bugonemail\Facades\BugeExceptionFacade{
        ...
        public static function setEnvironment($env){
            return \Dinesh\Bugonemail\BugeException::setEnvironment($env);
        }
        ...
        public static function notifyException($exception){
            return \Dinesh\Bugonemail\BugeException::notifyException($exception);
        }
